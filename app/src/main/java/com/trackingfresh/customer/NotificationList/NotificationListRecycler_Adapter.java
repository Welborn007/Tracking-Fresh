...
public class NotificationListRecycler_Adapter extends RecyclerView.Adapter<NotificationListRecycler_Adapter.RecyclerViewHolder>{

    private List<NotificationSubPOJO> NotificationListReView;
    private String TAG = this.getClass().getSimpleName();
    private Context context;

    public NotificationListRecycler_Adapter(List<NotificationSubPOJO> NotificationListReView,Context context)
    {
    ...
    @Override
    public NotificationListRecycler_Adapter.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.notification_row_layout,parent,false);

        NotificationListRecycler_Adapter.RecyclerViewHolder recyclerViewHolder = new NotificationListRecycler_Adapter.RecyclerViewHolder(view);

        return recyclerViewHolder;
    }

    @Override
    public void onBindViewHolder(NotificationListRecycler_Adapter.RecyclerViewHolder holder, final int position) {
