package com.trackingfresh.customer.TKCash.Paid;
...
public class Paid_Fragment extends Fragment {
    ...
    public static Paid_Fragment newInstance(int a,String s) {
        Paid_Fragment fragmentfirst= new Paid_Fragment();
    ...
    public static Paid_Fragment hideInstance(String s) {
        Paid_Fragment fragmentfirst= new Paid_Fragment();
        Bundle args = new Bundle();
        args.putInt("1", page);
        args.putString("no.1", title);
    ...
    private void fetchAllWalletTransaction() {
        try {
            ...
            String url = Constants.PaidWalletTransactions;
